    ...
    <Page style={{ marginBottom: '100px' }}>
      ...
      <AppBody>
        <AppHeader
          ...
          backTo="/pool"
          noConfig="false"
          helper="When you add liquidity, you are given pool tokens representing your position. These tokens automatically earn fees proportional to your share of the pool, and can be redeemed at any time."
        />
        <CardBody>
          <AutoColumn gap="20px">
            {noLiquidity && (
              <ColumnCenter>
                <Message variant="warning">
                  <div>
                    <Text bold mb="8px" style={{ fontFamily: 'Poppins' }}>
                      {t('You are the first liquidity provider.')}
                    </Text>
                    <Text mb="8px" style={{ fontFamily: 'Poppins' }}>
              ...
              <>
                <LightCard padding="0px" borderRadius="20px">
                  <RowBetween padding="1rem">
                    <Text fontSize="14px" style={{ fontFamily: 'Poppins', color: '#05489c' }}>
